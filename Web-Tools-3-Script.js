...
document.getElementById('Push-Refresh-All-User').addEventListener('click', function () {
    ...
    StatusUpdateBox("Web-Tools", "Đang gửi yêu cầu...", "green");
    fetch(scriptURL, {
        method: 'POST',
        headers: {
...
document.getElementById('updateA1Btn').addEventListener('click', function () {
    ...
    fetch(scriptURL, {
        ...
        .catch(error => {
            console.error('Error:', error);
            StatusUpdateBox("Lịch Trực Cuối Tuần", "Đã có lỗi xảy ra: " + error.message, "red");
        })
        .finally(() => {
...
async function fetchAndDisplayCheckIDInformation() {
    ...
    try {
        ...
        result.forEach((item, index) => {
            ...
            input.checked = localStorage.getItem('checkboxState' + index) === 'checked';

            input.addEventListener('change', () => {
                localStorage.setItem('checkboxState' + index, input.checked ? 'checked' : 'unchecked');
            });
...
//     // StatusUpdateBox("More Documents", "Đã cập nhật xong", "green");
// });
...
function createSMSLine(SMSList) {
    ...
    if (AdddivWrapper) {
        ...
        AdddivWrapper.addEventListener('click', () => {
            ...
            //     BoxEditPersonalSMS.classList.remove('DisplayNoneST');
            //     BoxEditPersonalSMS.classList.add('flexST');
            // }
        });
    }
...
document.getElementById('save-button-for-BoxEditPersonalSMS').addEventListener('click', () => {
    ...
    savePersonalSMS();
    StatusUpdateBox("My Personal SMS", "Đã lưu thành công", "green");
});
...
//             // Gọi animation sau khi render xong
