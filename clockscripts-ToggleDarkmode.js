...
const iframwebtool2ID = document.getElementById('iframwebtool2-container-ID');
const iframwebtool2container = document.getElementById('iframwebtool2-container');
...
clockContainer.addEventListener('click', function(event) {
    ...
    iframwebtool2container.style.display = 'none';
});
...
iframwebtool2ID.addEventListener('click', function(event) {
    event.stopPropagation();
    converterTimeContainer.style.display = 'none';
    MyToDoListcontainer.style.display = 'none';
    toggledarklightmodecontainer.style.display = 'none';
    calculatorcontainer.style.display = 'none';
    lichtruccuoituancontainer.style.display = 'none';
    iframwebtool2container.style.display = 'block';
});
...
document.addEventListener('click', function(event) {
    if (
        ...
        !iframwebtool2ID.contains(event.target) &&
        !iframwebtool2container.contains(event.target)
    ) {
        converterTimeContainer.style.display = 'none';
        MyToDoListcontainer.style.display = 'none';
        toggledarklightmodecontainer.style.display = 'none';
...
// Di chuyển đồng hồ khi hover cái Tool Bar
